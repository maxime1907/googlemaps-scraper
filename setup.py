...
with open(rel("src", "gmaps_scraper", "__init__.py")) as f:
...
setup(
    ...
    version=version,
    author="gaspa93",
    author_email="mattiagasparini2@gmail.com",
    ...
    entry_points={"console_scripts": ["gmaps_scraper=gmaps_scraper.cli:cli"]},
)
